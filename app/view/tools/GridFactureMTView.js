Ext.define('MainApp.view.tools.GridFactureMTView', {
	...
	initComponent: function() { 
		this.columns = [
			...
			{header: 'Tarif', dataIndex: 'Tarif',  flex:1}, 
			...
			{header: 'Ancien Index Pointe', dataIndex: 'Ancien_Index_Pointe',  flex:10, hidden: true}, 
			{header: 'Nouvel Index Pointe', dataIndex: 'Nouvel_Index_Pointe',  flex:5, hidden: true}, 
			...
			{header: 'Net Depass', dataIndex: 'Montant_Net_Penalite_Depassement_PS',  flex:7}, 
